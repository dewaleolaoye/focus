...
class BlockerApplication : Application() {
    val audience by lazy { com.websiteblocker.app.privacy.AudienceStore(this) }
    val disclosures by lazy { com.websiteblocker.app.privacy.DisclosureConsentStore(this) }
    val adsConsent by lazy { com.websiteblocker.app.privacy.AdsConsentManager(this) }
