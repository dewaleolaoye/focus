...
import com.usefocus.app.vpn.WebsiteBlockVpnService
...
class AppBlockingIntegrationTest {
    ...
    fun nativeBlockingAndWebsiteFilteringWorkTogether() = runBlocking {
        ...
        val component = "com.usefocus.app/com.usefocus.app.accessibility.AppBlockAccessibilityService"
        ...
        try {
            ...
            shell("appops set com.usefocus.app ACTIVATE_VPN allow")
            ...
            shell("am start -n com.usefocus.app/.MainActivity")
            openYoutube()
            waitForPackage(launcher)
            ...
            if (!hadVpnConsent) shell("appops set com.usefocus.app ACTIVATE_VPN default")
            if (android.os.Build.VERSION.SDK_INT >= 33 && !youtubeNotificationsGranted)
