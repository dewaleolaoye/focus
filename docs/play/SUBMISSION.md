...
5. The owner specified **adults and teenagers**: select the applicable 13–15, 16–17 and 18+ target-audience groups in Play Console, not under-13 groups. Verify the country-specific audience/content-rating questions and actual marketing. Do not claim parental-control or disability-assistance functionality.
...
| --- | --- | --- |
| Schedules, rules, consent versions/times | On-device database/preferences only; backups disabled | Not off-device collection by Focus. Explain local retention/deletion in policy. |
